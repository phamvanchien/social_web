...
const LocationView = ({ onLocationSelected }: LocationViewProps) => {
  ...
  if (!scriptLoaded || !initialPosition) {
    return (
      <section className="relative flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
        <div className="text-center">
          <Loading size="lg" variant="spinner" />
          <p className="mt-4 text-sm text-gray-600">Đang lấy vị trí của bạn...</p>
        </div>
      </section>
    );
  }
      ...
      <div className="relative w-full max-w-4xl">
        <div className="rounded-3xl bg-white p-8 shadow-xl ring-1 ring-black/5 backdrop-blur-sm">
          ...
          <div className="mb-6 text-center">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Chọn vị trí của bạn</h1>
          ...
          {/* Map Container */}
          <div className="mb-6">
            <div ref={mapRef} className="h-[400px] w-full rounded-2xl overflow-hidden border-2 border-gray-200" />
          </div>
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <Button
              ...
              className="h-12 rounded-xl border-2 border-blue-200 bg-blue-50 font-medium text-blue-700 shadow-sm transition hover:border-blue-300 hover:bg-blue-100 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
            >
