        ...
        <div className="w-full max-w-[448px]">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-12 bg-[#0C8BDA] text-white rounded-xl text-[15px] font-semibold cursor-pointer transition-colors hover:bg-[#0A7BC4] disabled:opacity-70 disabled:cursor-not-allowed mb-4"
            >
              {loading ? <Loading size="md" variant="spinner" color="white" /> : "Đăng nhập"}
            </button>
            ...
            <div className="grid grid-cols-2 gap-3 mb-8">
              ...
              <button
                ...
                className="h-12 flex items-center justify-center gap-2 bg-white dark:bg-gray-900 border border-[#d1d5db] dark:border-gray-700 rounded-3xl text-[15px] font-medium text-[#1a1a1a] dark:text-gray-100 cursor-pointer transition-colors hover:bg-[#f9fafb] dark:hover:bg-gray-800 disabled:opacity-70 disabled:cursor-not-allowed"
              >
                {googleLoginLoading ? (
                  <Loading size="sm" variant="spinner" color="rgb(99 102 241)" />
                ) : (
                  <>
