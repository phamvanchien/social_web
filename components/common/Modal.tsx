  ...
  return createPortal(
    ...
    >
      ...
      <div className={`absolute inset-0 flex ${alignClass} justify-center overflow-y-auto`}>
        ...
        >
          <div className={`bg-white rounded-2xl shadow-xl ring-1 ring-black/5 ${className}`}>
            {/* Header */}
            {(title || showCloseButton) && (
              <div className="relative flex items-center justify-center px-5 pt-5">
                {title && (
                  <h2
                    id={titleId}
                    className="text-lg font-semibold tracking-tight text-neutral-900 text-center"
                  >
                    {title}
                  </h2>
                )}
                ...
                {showCloseButton && (
                  <button
                    type="button"
                    onClick={onClose}
                    className="cursor-pointer absolute right-5 top-5 inline-flex shrink-0 items-center justify-center rounded-xl p-2 text-neutral-600 hover:bg-neutral-100 hover:text-neutral-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-400"
...
export function ModalPrimaryButton(
  ...
  return (
    <button
      {...props}
      className={`cursor-pointer inline-flex items-center justify-center rounded-xl px-4 py-2 text-sm font-medium shadow-sm ring-1 ring-black/5 focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-400 disabled:opacity-50 bg-neutral-900 text-white hover:bg-neutral-800 ${props.className ?? ""}`}
    />
  );
}
...
export function ModalSecondaryButton(
  ...
  return (
    <button
      {...props}
      className={`cursor-pointer inline-flex items-center justify-center rounded-xl px-4 py-2 text-sm font-medium shadow-sm ring-1 ring-black/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-400 disabled:opacity-50 bg-white text-neutral-900 hover:bg-neutral-50 ${props.className ?? ""}`}
    />
  );
}
