  ...
  return createPortal(
    ...
    >
      ...
      <div className={`absolute inset-0 flex ${alignClass} justify-center overflow-y-auto`}>
        ...
        >
          <div className={`bg-white dark:bg-neutral-900 rounded-2xl shadow-xl ring-1 ring-black/5 ${className}`}>
            {/* Header */}
...
export function ModalPrimaryButton(
  ...
  return (
    <button
      {...props}
      className={`cursor-pointer inline-flex items-center justify-center rounded-xl px-4 py-2 text-sm font-medium shadow-sm ring-1 ring-black/5 focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-400 disabled:opacity-50 bg-neutral-900 text-white hover:bg-neutral-800 dark:bg-white dark:text-neutral-900 dark:hover:bg-neutral-200 ${props.className ?? ""}`}
    />
  );
}
...
export function ModalSecondaryButton(
  ...
  return (
    <button
      {...props}
      className={`cursor-pointer inline-flex items-center justify-center rounded-xl px-4 py-2 text-sm font-medium shadow-sm ring-1 ring-black/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-400 disabled:opacity-50 bg-white text-neutral-900 hover:bg-neutral-50 dark:bg-neutral-800 dark:text-white dark:hover:bg-neutral-700 ${props.className ?? ""}`}
    />
  );
}
